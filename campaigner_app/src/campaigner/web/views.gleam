...
pub fn render_chat(vm: ChatViewModel) -> Element(msg) {
  section([class("chat-container")], [
    ...
    script(
      [],
      "document.querySelector('.chat-form').addEventListener('submit', function() { this.querySelector('.btn-submit').classList.add('loading'); this.querySelector('.chat-input').setAttribute('readonly', 'readonly'); });",
    ),
    case vm.error {
      "" -> element.none()
